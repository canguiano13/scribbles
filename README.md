...
- [meme-app](./meme-app): A meme app for cat lovers.
...
- [static-insta](./static-insta): A simple static instagram clone with three posts.
- [twiiter-clone](./twitter-clone): A very stripped-down twitter clone.
